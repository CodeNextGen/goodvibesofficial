...
class FavsMusicList extends StatefulWidget {
  @override
  _FavsMusicListState createState() => _FavsMusicListState();
}

class _FavsMusicListState extends State<FavsMusicList> {
  final _locator = locator<MusicService>();

  Future<List<Track>> getFavs() async {
    Database db;
